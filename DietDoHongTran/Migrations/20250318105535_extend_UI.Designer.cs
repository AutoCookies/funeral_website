...
namespace DietDoHongTran.Migrations
{
    ...
    [Migration("20250318105535_extend_UI")]
    partial class extend_UI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DietDoHongTran.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DietDoHongTran.Models.Product", b =>
                {
                    b.HasOne("DietDoHongTran.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DietDoHongTran.ViewModels.ServiceProduct", b =>
                {
                    ...
                    b.HasOne("DietDoHongTran.Models.Service", "Service")
                        .WithMany("ServiceProducts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DietDoHongTran.Models.ApplicationUser", null)
                        .WithMany()
